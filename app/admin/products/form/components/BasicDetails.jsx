    ...
    <section className="flex-1 flex flex-col gap-3 bg-white rounded-xl p-4 border">
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="product-title" className="text-gray-500 text-xs">
          Product Name <span className="text-red-600">required</span>
        </label>
        <input
          type="text"
        ...
        <div className="flex flex-col gap-1">
          ...
          >
            Short Description<span className="text-red-600"> required</span>
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="product-brand" className="text-gray-500 text-xs">
            Brand<span className="text-red-600"> required</span>
          </label>
          <select
            type="text"
            id="product-brand"
        ...
        <div className="flex flex-col gap-1">
          <label
            ...
            className="text-gray-500 text-xs"
          >
            Stock<span className="text-red-600"> required</span>
          </label>
          <input
            type="number"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="product-price" className="text-gray-500 text-xs">
            Price<span className="text-red-600"> required</span>
          </label>
          <input
            type="number"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="product-sale-price" className="text-gray-500 text-xs">
            Sale Price<span className="text-red-600"> required</span>
          </label>
          <input
            type="number"
